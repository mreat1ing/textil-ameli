...
const ServicesDesign: FC = () => {
  return (
    <div className="services-design">
      ...
      <p className="services-p">
        У нас всегда в наличии более{' '}
        <strong className="services-p--strong">7000 вариантов ткани</strong> под
        любую задачу — от небольшой шторы для ванной комнаты до оснащения
        текстилем отеля. Мы работаем только с проверенными поставщиками ткани
        премиум-класса. Как результат, наши изделия служат долгие годы и
        выдерживают множество стирок. <br />
      </p>
      <p className="services-p">
